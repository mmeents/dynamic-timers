...
/// <summary>
/// Represents a cron expression with support for standard 5-field format (minute hour day month weekday).
/// Supports wildcards (*), ranges (1-5), steps (*/5), and comma-separated values (1,3,5).
/// </summary>
internal class CronExpression
{
    ...
    /// <summary>
    /// Calculates the next occurrence of the cron schedule after the specified date/time.
    /// </summary>
    /// <param name="from">The starting date/time.</param>
    /// <returns>The next occurrence, or null if no match found within 4 years.</returns>
    ...
    /// <param name="result">The parsed CronExpression, or null if parsing failed.</param>
